...
└── tests/              # 9 file test, 32 test cases
\end{Verbatim}
...
test\_store.py & vectorstore/store & 4 & PASS \\
test\_generator.py & generation/generator & 6 & PASS \\
test\_pipeline.py & pipeline/rag & 2 & PASS \\
test\_evaluator.py & evaluation/evaluator & 1 & PASS \\
test\_server.py & server (API + SSE) & 7 & PASS \\
test\_export\_vector\_map.py & scripts/export\_vector\_map & 2 & PASS \\
\midrule
\textbf{TỔNG} & --- & \textbf{32} & \textbf{32/32 PASS} \\
\bottomrule
\end{tabularx}\\[4pt]
...
Test coverage & 32/32 PASS & Toàn bộ test cases \\
